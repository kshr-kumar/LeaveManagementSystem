...
namespace LMMS.Core
{
    ...
    public partial class AppDbContextProcedures : IAppDbContextProcedures
    {
        ...
        public virtual async Task<int> InitializeLeaveBalanceAsync(int? ID, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            ...
            var _ = await _context.Database.ExecuteSqlRawAsync("EXEC @returnValue = [dbo].[InitializeLeaveBalance] @ID = @ID", sqlParameters, cancellationToken);
